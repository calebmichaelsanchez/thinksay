	...
	<article>
		...
		<div class="home-features">
			<div id="carousel" class="carousel slide" data-ride="carousel">
				<?php 
					$homevid1 = $page->homevid1();
					$homevid2 = $page->homevid2();
					$homevid3 = $page->homevid3();
					$homevid4 = $page->homevid4();
					$homevid5 = $page->homevid5();
				?>
			  <!-- Wrapper for slides -->
			  <div class="carousel-inner">
			    <?php if($homevid1 === '') {} else { ?>
			    <div class="item wrapper active">
			    	<iframe  src="//www.youtube.com/embed/<?php echo $homevid1; ?>" frameborder="0" allowfullscreen></iframe>
			    </div>
			    <?php } ?>
			    <?php if($homevid2 == '') {} else { ?>
			    <div class="item wrapper">
			    	<iframe  src="//www.youtube.com/embed/<?php echo $homevid2; ?>" frameborder="0" allowfullscreen></iframe>
			    </div>
			    <?php } ?>
			    <?php if($homevid3 == '') {} else { ?>
			    <div class="item wrapper">
			    	<iframe  src="//www.youtube.com/embed/<?php echo $homevid3; ?>" frameborder="0" allowfullscreen></iframe>
			    </div>
			    <?php } ?>
			    <?php if($homevid4 == '') {} else { ?>
			    <div class="item wrapper">
			    	<iframe  src="//www.youtube.com/embed/<?php echo $homevid4; ?>" frameborder="0" allowfullscreen></iframe>
			    </div>
			    <?php } ?>
			    <?php if($homevid5 == '') {} else { ?>
			    <div class="item wrapper">
			    	<iframe  src="//www.youtube.com/embed/<?php echo $homevid5; ?>" frameborder="0" allowfullscreen></iframe>
			    </div>
			    <?php } ?>
			  </div>
		...
		<div class="recent-articles">
			...
			<div>
			    ...
			    <p><?php echo excerpt($article->text(), 700); ?></p>
...
<section class="home-artists">
	<article>
		<div id="carousel-2" class="carousel slide" data-ride="carousel">
		  ...
		  <!-- Wrapper for slides -->
		  <div class="carousel-inner">
				<?php foreach($site->find('artists')->children()->visible() as $article): ?>    
		    <div class="item <?php if($article->title() == 'David Duchovny') {echo 'active';} ?>">
		    	
		    	<div class="featured-artist">
		    		
		    		<div class="artist-profile">
		    			<a href="<?php echo $article->url(); ?>"><img src="<?php echo $article->images()->find('artist.jpg')->url(); ?>"></a>
		    			<h5><?php echo $article->title(); ?></h5>
		    		</div>

		    		
		    		<!-- Show Featured Releases -->

						<?php 
						$recent1 = $article->images()->find('recent1.jpg');
						if(isset($recent1)) { ?>
						<div class="recent-items">
							...
							<ul class="recently-released">
								<?php
									if(isset($recent1)) { ?>
								<li>
									<img src="<?php echo $recent1->url(); ?>">
									<?php }

									$itunes1 = $article->itunes1();
									$spotify1 = $article->spotify1();
									$amazon1 = $article->amazon1();
									if(isset($recent1)) { ?>
									<ul class="find-music">
										<?php if($itunes1 != '') { ?>
										<li>
									...
									$recent2 = $article->images()->find('recent2.jpg');
									if(isset($recent2)) { ?><li>
									<img src="<?php echo $recent2->url(); ?>" alt="">
								<?php } 

									$itunes2 = $article->itunes2();
									$spotify2 = $article->spotify2();
									$amazon2 = $article->amazon2();
									if(isset($recent2)) { ?>
									<ul class="find-music">
										<?php if($itunes2 != '') { ?>
										<li>
						...
						<!-- If NO recent releases then show Featured Articles -->
			    	...
			    	<div class="featured-items">
			    		<div class="page-title">
							...
							<ul class="featured-places">
								<?php 
									$featured1 = $article->images()->find('feature1.jpg');
									$featured2 = $article->images()->find('feature2.jpg');
									$featured3 = $article->images()->find('feature3.jpg');

									if(isset($featured1)) {
								?>
								<li>
									<a target="_new" href="<?php echo $article->featurelink1(); ?>"><img src="<?php echo $featured1->url(); ?>" alt=""></a></li><?php } if(isset($featured2)) { ?><li>
									<a target="_new" href="<?php echo $article->featurelink2(); ?>"><img src="<?php echo $featured2->url(); ?>" alt=""></a></li><?php } if(isset($featured3)) { ?><li>
									<a target="_new" href="<?php echo $article->featurelink3(); ?>"><img src="<?php echo $featured3->url(); ?>" alt=""></a></li><?php } ?>
							</ul>
						</div>
						<?php } ?>
